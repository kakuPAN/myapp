...
Rails.application.config.sorcery.configure do |config|
  ...
  config.google.secret = Rails.application.credentials.dig(:google, :secret_id)
  # config.google.callback_url = "http://localhost:3000/oauth/callback?provider=google"
  config.google.callback_url = "https://task-machi-app.onrender.com/oauth/callback?provider=google"
  ...
  # config.line.secret = ENV['LINE_SECRET_KEY']
